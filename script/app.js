...
[
	...
	new Question("Зачем нам нужны навыки коспектирования?", 
	[
		new Answer("далее", 1)
	]),
	new Question("Как правильно делать конспект и что нам поможет для этого? ", 
	[
		new Answer("далее", 1)
	]),
	new Question("А какие задания для Вас показались самыми увлекательными, а какие Вы не поняли😃", 
	[
		new Answer("далее", 1),
	]),
